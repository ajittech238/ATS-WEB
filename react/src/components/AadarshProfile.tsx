...
//               {/* EXPERIENCE → MOVED TO RIGHT SIDE */}
//               <div className="bg-white rounded-xl shadow-sm p-8">
//                 <h2 className="text-2xl font-bold text-orange-600 mb-8 flex items-center gap-2">
...
// ⚠️ FIX: Import the profile image correctly using a relative path
...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  <div className="border border-orange-200 rounded-xl p-6 bg-white shadow-sm">
    {/* 💡 Responsive Elements: Stack image and text vertically on mobile (default) 
    ...
    <div className="min-h-screen bg-gradient-to-r from-orange-50 via-white to-orange-100 text-gray-900">
      ...
      <section className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 relative -mt-32">
          ...
          {/* 💡 Responsive Elements: Stacks vertically (flex-col) by default, horizontal on large screens (lg:flex-row) */}
          <div className="flex flex-col lg:flex-row items-start lg:items-end gap-8">

            {/* Profile Image */}
            <div className="relative">
              <img
                src={RahulImage} // ⚠️ FIX: Using imported image variable
                alt="Rahul Kumawat"
                className="w-48 h-48 rounded-full border-8 border-white shadow-2xl object-cover"
              />
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* 💡 Responsive Elements: Single column (default) up to tablet, two columns on desktop (lg:grid-cols-3) 
