...
//   Target,
//   MessageSquare,
//   ChevronsRight, // For Quick Service Details
// } from "lucide-react";

// // स्थिरांक: पता (Address Constant)
// const OFFICE_ADDRESS = "Codercom Building, A4, Ajmer Rd, Purani Chungi, Vidhyut Nagar, Jaipur, Rajasthan 302021";
...
//       {/* 1. HEADER/CTA SECTION (Theme Applied & Address Updated) */}
...
//         {/* Decorative Background Lights (Teal Theme) */}
...
//         <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>

//         {/* Content */}
//         <div className="relative z-10 max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
//           <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-teal-700">
...
//             {/* Email */}
//             <div className="bg-white p-8 rounded-2xl shadow-md border border-teal-100 hover:shadow-lg transition">
//               <h3 className="text-xl font-semibold text-teal-600 mb-2">📧 Email Us</h3>
...
//             {/* Phone */}
//             <div className="bg-white p-8 rounded-2xl shadow-md border border-teal-100 hover:shadow-lg transition">
//               <h3 className="text-xl font-semibold text-teal-600 mb-2">📞 Call Us</h3>
...
//             <div className="bg-white p-8 rounded-2xl shadow-md border border-teal-100 hover:shadow-lg transition">
//               <h3 className="text-xl font-semibold text-teal-600 mb-2">📍 Visit Us</h3>
...
//       {/* 2. Contact Info + Form (Layout: Map Left, Form Right) */}
...
//             {/* 2a. MAP SECTION (Moved to Left Top) */}
//             <div className="bg-white border border-teal-200 rounded-lg shadow-lg">
//                 <div className="p-8">
//                 <h3 className="text-2xl font-semibold text-teal-700 mb-4">
//                     Find Our Location
//                 </h3>
//                 <div className="relative h-80 rounded-lg overflow-hidden border border-teal-100">
//                     <iframe
...
//             {/* 2b. CONTACT INFORMATION (Address Updated) */}
//             <div>
...
//           {/* RIGHT COLUMN: Contact Form + New Content (Service Details) */}
//           <div className="space-y-12">
            
//             {/* 2c. CONTACT FORM (Moved to Right Top, Teal Theme) */}
//             <div className="bg-white border border-teal-200 rounded-lg shadow-lg">
//                 <div className="p-8">
...
//                         className="w-full border border-teal-200 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-400 focus:outline-none"
//                     />
//                     <input
//                         type="email"
//                         name="email"
...
//                     <button
//                     type="submit"
//                     className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white py-3 rounded-md font-semibold transition"
//                     >
...
//             {/* 2d. NEW CONTENT BLOCK: Quick Service Details (Teal Theme) */}
//             <div className="bg-white border border-teal-200 rounded-lg shadow-lg p-8">
...
//                     {/* ICON: ChevronsRight is teal/black */}
...
//             {[
//               // ICON: Icon color inside gradient is white
...
//             ].map((item, i) => (
//               <div key={i} className="bg-white border border-teal-200 rounded-xl p-6 shadow hover:shadow-teal-300/40 transition">
