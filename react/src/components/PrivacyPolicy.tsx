...
// Roman Font: Playfair Display for a professional, classic feel
const romanFont = `
  @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&display=swap');
  .font-roman { font-family: 'Playfair Display', serif; }
`;

const API_KEY = ""; // Keep this empty; the environment will provide it.
...
const PrivacyPolicy: React.FC = () => {
  ...
  // Base style for the interactive section cards
  ...
  // Function to fetch the image from the Imagen API with exponential backoff
  const generateImage = async () => {
    ...
    while (attempts < maxAttempts) {
        ...
        break; // Break the loop on success or final failure
    }
  ...
  return (
    <>
      {/* Injecting custom font CSS */}
      <style>{romanFont}</style>

      {/* Main container with gradient background and deep text color */}
      <div className="bg-gradient-to-br from-white to-orange-50 text-gray-900 min-h-screen pt-20 pb-16 px-4 sm:px-6 font-roman">
        <div className="max-w-6xl mx-auto">
            ...
            {isLoading ? (
              <div className="flex flex-col items-center justify-center text-gray-600">
                ...
                <div className="flex flex-col items-center justify-center text-red-600 p-8">
                    ...
                    <p className="text-xs mt-2">Using default placeholder for layout.</p>
                </div>
            ) : (
                <img
                    src={heroImageUrl || "https://plus.unsplash.com/premium_photo-1709713745246-acd3260f16a8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTl8fGNvbXBhbnklMjBwcml2YWN5JTIwcG9saWN5JTIwaW1hZ2V8ZW58MHx8MHx8fDA%3D"}
          ...
          <div className="space-y-24">
            ...
            {/* SECTION 1 – What Information We Collect (Image Left) */}
            <div className={`grid md:grid-cols-2 gap-10 items-start ${cardStyle}`}>
              <img
                // Thematic Placeholder: Data Collection
              ...
              <div className="md:order-last">
                ...
                <p className="text-gray-900 leading-relaxed mb-4">
                  We collect several data types to improve your overall experience including **Personal Identifiable Information (PII)**
                  such as your full name, email address, phone number, company affiliation, and project details, which are voluntarily provided when you fill out contact forms or sign up for services. 
                </p>
                <p className="text-gray-900 leading-relaxed">
                  We also gather **Non-Personal Data** including device details (browser type, operating system), IP address,
                  time spent on the site, and interaction logs. This helps us ensure we offer an optimized
                  service tailored for your device and analyze site performance. **Cookies and similar tracking technologies**
                  are used for better personalization, smoother navigation, and accurate traffic analysis across the platform.
                </p>
              </div>
            </div>

            {/* SECTION 2 – How Your Data Is Used (Image Right) */}
            <div className={`grid md:grid-cols-2 gap-10 items-start ${cardStyle}`}>
              <div className="md:order-first">
                ...
                <p className="text-gray-900 leading-relaxed mb-4">
                  Your data is primarily used to **provide, maintain, and improve our services**. We utilize your information
                  to fulfill your requests, customize the services you see, enhance website speed and performance, and manage
                  our relationship with you, including accurate troubleshooting whenever needed.
                </p>
                <p className="text-gray-900 leading-relaxed">
                  Data insights allow us to conduct internal research, prevent potential illegal activities, and enhance site security. 
                  Furthermore, your preferences enable personalized communication and delivery of relevant updates and marketing materials (only with your consent). 
                  We adhere strictly to using data only for platform enhancement and business operations as outlined herein.
                </p>
              </div>
              <img
                // Thematic Placeholder: Data Usage
            ...
            {/* SECTION 3 – Data Sharing and Disclosure (Image Left) */}
            <div className={`grid md:grid-cols-2 gap-10 items-start ${cardStyle}`}>
              <img
                // Thematic Placeholder: Data Sharing
            ...
            {/* SECTION 4 – Data Retention and Security Measures (Image Right) */}
            <div className={`grid md:grid-cols-2 gap-10 items-start ${cardStyle}`}>
              <div className="md:order-first">
                <h2 className="text-3xl font-bold text-orange-600 mb-4">
              ...
              <img
                // Thematic Placeholder: Retention and Security
            ...
            {/* NEW SECTION 5 – Children's Privacy (Full Width) */}
            ...
            {/* NEW SECTION 6 – Changes to this Privacy Policy (Full Width) */}
            <div className={`md:col-span-2 ${cardStyle}`}>
              <h2 className="text-3xl font-bold text-orange-600 mb-4">
          ...
          <div className="text-center mt-24 pt-6 border-t-2 border-orange-200">
            <p className="text-gray-500 text-md">
              <span className="font-semibold text-gray-700">Need immediate assistance or have privacy concerns?</span> Contact our dedicated team at 
              <a href="mailto:info@atsglobaltech.in" className="text-orange-600 hover:text-orange-800 transition font-semibold"> info@atsglobaltech.in</a>.
            </p>
          </div>
