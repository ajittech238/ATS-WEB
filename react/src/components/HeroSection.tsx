...
const HeroSection: React.FC = () => {
  ...
  return (
    // FIX 1: Removed 'px-4' from the main section to prevent overflow issues caused by padding.
    // The overflow is now handled by the outer section, and padding is applied to the inner container.
    <section className="relative bg-gray-50 mb-4 min-h-[500px] overflow-x-hidden font-serif">
      
      {/* Container added to hold content and re-introduce horizontal padding (px-4) */}
      <div className="flex flex-col lg:flex-row h-full w-full px-4 gap-[10px] lg:gap-[10px]">
        ...
        <div className="relative w-full lg:w-[60%] flex items-center justify-center text-white px-8 py-16 rounded-[10px] overflow-hidden min-h-[300px]">
          ...
          <div className="relative max-w-2xl text-center lg:text-left z-10" data-aos="flip-left"
            ...
            <h1 className="flex items-center gap-4 text-5xl md:text-6xl font-extrabold leading-none whitespace-nowrap mb-4">
              ...
              {/* INLINE SLIDER */}
              {/* FIX 2: Replaced w-[420px] with max-w-full to ensure it scales correctly on smaller screens */}
              <div className="relative overflow-hidden h-[70px] max-w-full"> 
                {slidingTexts.map((text, i) => (
                  <span
                    key={i}
                    className={`
